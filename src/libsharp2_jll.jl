...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libsharp2_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("180207a7-b08e-5162-af94-7d62a04fe081"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libsharp2", artifacts_toml) for e in artifacts["libsharp2"]]
...
if best_platform === nothing
    @debug("Unable to load libsharp2; unsupported platform $(triplet(platform_key_abi()))")
else
